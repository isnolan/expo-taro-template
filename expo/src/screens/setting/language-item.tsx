...
export const LanguageItem = () => {
  ...
  const langs = React.useMemo(
    () => [
      ...
      { label: translate('settings.chinese'), value: 'zhCN' },
    ],
    [],
  );
  ...
  return (
    <>
      <Item text="settings.language" value={selectedLanguage?.label} onPress={open} />
      <Options ref={optionsRef} options={langs} onSelect={onSelect} value={selectedLanguage?.value} />
    </>
  );
};
